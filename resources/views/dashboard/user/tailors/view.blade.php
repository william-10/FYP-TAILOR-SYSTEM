    ...
    <div class="card shadow">
        <div class="card-body">
            <div class="row">
                <div class="col-md-4">
                    <div class="span2">
                        <img src="{{asset('storage/avator/'.$unique_tailor->avator)}}" alt="image here" class="card-img-top2 "
                            width="100%" height="90%">
                    </div>
                </div>
                <div class="col-md-8">
            ...
            @if (count($unique_tailor->categories)>0)
<div class="col-md-12">
...
@endif
            ...
            <form action="{{url('user/put-request')}}" method="POST">
                ...
                <input type="hidden" value="{{ $unique_tailor->tailor_id }}" name="tailor_id">
                <div class="col-md-12">
                    <button type="submit" class="btn btn-primary btn-sm float-end" onclick="return confirm('Do you want to request apointment to the tailor?')">Request</button>
