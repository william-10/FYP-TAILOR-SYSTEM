                        ...
                        <div class="row">
                                        @if ($products->upper_part =='1')
                                                    ...
                                                    <div class="col-md-2 mb-3">
                                                        ...
                                                        <input type="number"  class="form-control mkono-input" autocomplete="off" value="0" name="mkono"></div>

                                                        <div class="col-md-2 mb-3">
                                                        <label for="">kifua</label>
                                                        <input type="number"  class="form-control kifua-input" autocomplete="off" value="0" name="kifua"></div>
                                ...
                                @if($products->lower_part =='1')
                                                        ...
                                                        <input type="number"  class="form-control kiuno-input" autocomplete="off" value="0" name="kiuno"></div>



                                                        <div class="col-md-2 mb-3">
                                                        <label for="">paja</label>
                                                        <input type="number"  class="form-control paja-input" autocomplete="off" value="0" name="paja"></div>
